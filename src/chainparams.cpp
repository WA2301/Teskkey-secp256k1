...
public:
    CMainParams() {
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,0);       //WA2301: 主网版本号为 0x00, LTC 则为0x30 = 48, Dogecoin 为0x1e = 30
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,5);       //        主网版本号为 0x05, LTC 则为0x32 = 50
...
public:
    CTestNetParams() {
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,111);    //WA2301: 测试网络 版本号为 0x6f,LTC 测试网络同样为 0x6f
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,196);    //        测试网络 版本号为 0xc4,LTC 测试网络同样为 0xc4??
