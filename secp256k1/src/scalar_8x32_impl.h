...
#define SECP256K1_N_0 ((uint32_t)0xD0364141UL)  //如果加法溢出则减去此值
...
#define SECP256K1_N_C_0 (~SECP256K1_N_0 + 1)    //用于减法运算
...
static int secp256k1_scalar_add(secp256k1_scalar *r, const secp256k1_scalar *a, const secp256k1_scalar *b) {
    ...
    secp256k1_scalar_reduce(r, overflow);     //WA2301:使得加法运算看起来不那么明显。。。。
    return overflow;
}
